...
#output: My name is Sarah Naqvi


2.  What values can a BOOLEAN contain?

In R, a boolean value is represented by the logical data type. It can contain either of the two possible values: TRUE or FALSE. These values are often used in conditional statements, logical operations, and comparisons
