...
mat_array <- array(c(vector1, vector2), dim = c(3, 3, 2))

# 1. Print the value 5 by indexing into the matrix
value_5_index <- which(mat_array == 5, arr.ind = TRUE)
print(mat_array[value_5_index])

# 2. Print the third row of the first matrix
print(mat_array[3,,1])

# 3. Print the second column of both matrices
print(mat_array[,2,])
